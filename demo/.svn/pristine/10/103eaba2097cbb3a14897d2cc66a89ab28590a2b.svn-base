...
public class DevelopersController {
    ...
    @RequestMapping(value="/skills",method=RequestMethod.POST)
   	public String skillsAdd(@RequestParam String label, 
    ...
    @RequestMapping(value="/deleteDeveloper/{id}")
    public String deleteDevelopers(@PathVariable Long id, Model model) {
